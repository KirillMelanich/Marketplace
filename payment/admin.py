...
def export_paid_to_csv(modeladmin, request, queryset):
    """
    Export the queryset data to a CSV file with the fields of the model specified by the model admin.
    :return: HttpResponse object containing the CSV data.
    """
...
def export_not_paid_to_csv(modeladmin, request, queryset):
    """
    Export the queryset data to a CSV file for the model specified by modeladmin.
    Return:
...
def order_pdf(obj):
    """
    Generate a PDF link for the given object.
    """
